...
(*html*
    <div class="twocol1">
      ...
      <p>
        ...
        to <em>Eliom</em> should be very easy.
    ...
    <div class="twocol1">
      ...
      <p>
          ...
          The <code>Eliom</code> module gives access to all the
          functions you need to communicate with the Ocsigen server,
          and <code>Eliom.Xhtml</code> defines all the functions you need
...
(*html*
   ...
   of a user, etc.). The page yo link to is redisplayed after the action.
   ...
   For example
     <code><span class="Cem">Actions.register_service</span></code>,
     <code><span class="Cem">Actions.register_new_service</span></code>,
     <code><span class="Cem">Actions.register_service_for_session</span></code>.<br/>
      </p>
...
(*html*
    ...
    <div class="twocol2 encadre">
      <p>Each of these registration may be done in the <em>public</em>
