...
(*              ["http://theorie.physik.uni-wuerzburg.de/~ohl/xhtml/"] *)
      ...
      <div class="encadre">
        ...
        it instead of XHTML.M and Eliomparameters.Xhtml
...
<tr><th class="row">$a ~service:(static_dir sp) ~sp [code [pcdata "Eliompredefmod.Any" ]] ["doc";version;"Eliompredefmod.Any.html"]$</th>
   ...
   <h2>2. Sessions, users and other common situations in Web sites</h2>
    ...
    <div class="twocol1">
      ...
      this table using $a ~fragment:"VALset_session_data" ~service:(static_dir sp) ~sp [code [pcdata "Eliomsessions.set_session_data" ]] ["doc";version;"Eliomsessions.html"]$ and 
      $a ~fragment:"VALget_session_data" ~service:(static_dir sp) ~sp [code [pcdata "Eliomsessions.get_session_data" ]] ["doc";version;"Eliomsessions.html"]$. The following example shows
    ...
    (html
       ...
       (body 
          [p [pcdata ("Welcome " ^ login ^ ". You are now connected."); 
              br ();
              Eliompredefmod.Xhtml.a session_data_example sp [pcdata "Try again"] ()
            ]]))
...
(*html*
    ...
    <div class="twocol1">
     ...
     <span class="Cem">$a ~fragment:"VALregister_for_session" ~service:(static_dir sp) ~sp [code [pcdata "Eliompredefmod.Xhtml.register_for_session" ]] ["doc";version;"Eliommkreg.ELIOMREGSIG1.html"]$</span>).<br/>
      ...
      without using $a ~fragment:"VALset_session_data" ~service:(static_dir sp) ~sp [code [pcdata "Eliomsessions.set_session_data" ]] ["doc";version;"Eliomsessions.html"]$.
...
let _ = 
  let c = ref 0 in
  let page sp () () = 
    let l3 = Eliompredefmod.Xhtml.post_form coservices_example_post sp 
        (fun _ -> [p [Eliompredefmod.Xhtml.string_input 
                        ~input_type:`Submit
                        ~value:"incr i (post)" ()]]) () 
    in
    let l4 = Eliompredefmod.Xhtml.get_form coservices_example_get sp 
        (fun _ -> [p [Eliompredefmod.Xhtml.string_input
                        ~input_type:`Submit
                        ~value:"incr i (get)" ()]]) 
    in 
    return
      (html
       ...
       (body [p [pcdata "i is equal to ";
              ...
              l4]))
  in
  Eliompredefmod.Xhtml.register coservices_example page;
...
let calc_handler sp () () =   
  let create_form intname = 
    [p [pcdata "Write a number: ";
        Eliompredefmod.Xhtml.int_input ~input_type:`Text ~name:intname ();
        br ();
        Eliompredefmod.Xhtml.string_input ~input_type:`Submit ~value:"Send" ()]]
  in
  let f = Eliompredefmod.Xhtml.get_form calc_i sp create_form in
  return
    (html 
       (head (title (pcdata "")) [])
       (body [f]))
...
let () =
  Eliompredefmod.Xhtml.register calc   calc_handler;
  Eliompredefmod.Xhtml.register calc_i calc_i_handler
(*html*
...
<pre>
   ...
   <span class="Cem">$a ~fragment:"VALclose_volatile_session" ~service:(static_dir sp) ~sp [code [pcdata "Eliomsessions.close_volatile_session" ]] ["doc";version;"Eliomsessions.html"]$</span> for both in memory data session and session services.
     ...
     <span class="Cem">$a ~fragment:"VALregister_for_session" ~service:(static_dir sp) ~sp [code [pcdata "register_for_session" ]] ["doc";version;"Eliommkreg.ELIOMREGSIG1.html"]$</span>, or
      $a ~fragment:"VALget_session_data" ~service:(static_dir sp) ~sp [code [pcdata "Eliomsessions.get_session_data" ]] ["doc";version;"Eliomsessions.html"]$.
    ...
    (fun _ () file ->
      let to_display = 
        ...
        (try
          Unix.unlink newname;
        with _ -> ());
        Unix.link (Eliomsessions.get_tmp_filename file) newname;
    ...
    return
     << 
       ...
       <body>
         ...
         <h1>$img ~alt:"Ocsigen" ~src:(Eliompredefmod.Xhtml.make_uri ~service:(static_dir sp) ~sp ["ocsigen5.png"]) ()$</h1>
