...
The [camlp4-to-ppx](https://github.com/janestreet/camlp4-to-ppx) tool can be used to translate source code using Camlp4 syntax extensions to PPX. We [provide a version](https://github.com/ocsigen/camlp4-to-ppx) of camlp4-to-ppx that handles all the Ocsigen extensions.
