...
val register : ?wake:bool -> Eliom_comet_base.comet_service ->
  'a Eliom_comet_base.chan_id -> 'a Lwt_stream.t
...
val close : Eliom_comet_base.comet_service -> 'a Eliom_comet_base.chan_id -> unit
