...
let tyxml_unwrap_id_int = Runtime.tyxml_unwrap_id_int
...
let client_value_unwrap_id_int = Runtime.client_value_unwrap_id_int
let () = assert (client_value_unwrap_id_int = 7)
let global_data_unwrap_id_int = Runtime.global_data_unwrap_id_int
