...
module Svg : sig
  ...
  module C : sig
    ...
    val node : ?init:'a elt -> 'a Html.elt Eliom_client_value.t -> 'a elt
    ...
    val attr : ?init:'a attrib -> 'a Html.attrib Eliom_client_value.t -> 'a attrib
...
module Html : sig
  ...
  module C : sig
    ...
    (** [node e] is a server-side node corresponding to the
        ...
        not allowed. *)
    val node :
      ?init:'a elt -> 'a Html.elt Eliom_client_value.t -> 'a elt

    val attr :
      ?init:'a attrib -> 'a Html.attrib Eliom_client_value.t -> 'a attrib
