module type PARAM = sig
  ...
  val input_attrib_append :
    input_attrib_t -> input_attrib_t -> input_attrib_t
  ...
  val select_content_cons :
    select_content_elt -> select_content_elt_list -> select_content_elt_list
  type select_attrib_t
  val a_select_required : [`Required] -> select_attrib_t
  val select_attrib_append :
    select_attrib_t -> select_attrib_t -> select_attrib_t
  ...
  val cons_hidden_fieldset :
    input_elt list -> form_content_elt_list -> form_content_elt_list
