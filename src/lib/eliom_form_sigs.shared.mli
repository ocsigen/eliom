...
module type LINKS = sig
  ...
  (** The function [css_link ~uri ()] creates a [<link>] node that
      ...
      {!Eliom_service.Http.create_external} to abstract the file with
      a service.
  ...
  (** The function [js_script ~uri ()] creates a [<script>] node that
      ...
      {!Eliom_service.create_external} to abstract the file with a
      service.
  ...
  val a :
    ...
    service:
      ('get, unit, Eliom_service.get, _, _, _, _,
       _, _, unit, _ Eliom_service.non_ocaml) Eliom_service.t ->
    ?hostname:string ->
    ?port:int ->
    ?fragment:string ->
    ?keep_nl_params:[ `All | `Persistent | `None ] ->
  ...
  val get_form :
    ...
    service:
      (_, unit, Eliom_service.get, _, _, _, _, _,
       'gn, _, _ Eliom_service.non_ocaml) Eliom_service.t ->
    ?hostname:string ->
    ?port:int ->
    ?fragment:string ->
    ?keep_nl_params:[ `All | `Persistent | `None ] ->
  ...
  val post_form :
    ...
    service:
      ('get, _, Eliom_service.post, _, _, _, _, _,
       _, 'pn, _ Eliom_service.non_ocaml) Eliom_service.t ->
    ?hostname:string ->
    ?port:int ->
    ?fragment:string ->
    ?keep_nl_params:[ `All | `Persistent | `None ] ->
