...
module type PARAM = sig
  ...
  val make_a : ?a:Html5_types.a_attrib attrib list -> ?href:uri -> 'a elt list -> 'a Html5_types.a elt
  val make_get_form :
  ...
  val cons_hidden_fieldset :
    ...
    Html5_types.form_content elt list
  val make_input : ?a:Html5_types.input_attrib attrib list -> ?checked:bool ->
    typ:input_type -> ?name:string -> ?src:uri ->
    ?value:string -> unit -> Html5_types.input elt
  val make_button : ?a:Html5_types.button_attrib attrib list -> button_type:button_type ->
  ...
  val make_css_link :
    ?a:Html5_types.link_attrib attrib list -> uri:uri -> unit -> Html5_types.link elt


  val make_js_script :
    ?a:Html5_types.script_attrib attrib list -> uri:uri -> unit -> Html5_types.script elt
...
module type S = sig
  ...
  *)
  ...
  val int_input :
    ?a:Html5_types.input_attrib attrib list -> input_type:input_type ->
  ...
  val image_input :
    ...
    ?src:uri -> unit -> Html5_types.input elt
  ...
  val raw_image_input :
    ?a:Html5_types.input_attrib attrib list ->
    name:string -> value:string -> ?src:uri -> unit -> Html5_types.input elt
  ...
  val bool_checkbox :
    ...
    name:[ `One of bool ] param_name -> unit -> Html5_types.input elt
  ...
  val int_checkbox :
    ?a:Html5_types.input_attrib attrib list -> ?checked:bool ->
    name:[ `Set of int ] param_name -> value:int -> unit -> Html5_types.input elt
  ...
  val int32_checkbox :
    ?a:Html5_types.input_attrib attrib list -> ?checked:bool ->
    name:[ `Set of int32 ] param_name -> value:int32 -> unit -> Html5_types.input elt
  ...
  val int64_checkbox :
    ?a:Html5_types.input_attrib attrib list -> ?checked:bool ->
    name:[ `Set of int64 ] param_name -> value:int64 -> unit -> Html5_types.input elt
  ...
  val float_checkbox :
    ?a:Html5_types.input_attrib attrib list -> ?checked:bool ->
    name:[ `Set of float ] param_name -> value:float -> unit -> Html5_types.input elt
