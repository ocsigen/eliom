...
let construct_params_string l =
  Url.make_encoded_parameters (Mod_parameters.get_param_list l)
...
type nl_params_set = (string * Mod_parameters.param) list String.Table.t
...
let string_of_nl_params_set nlp =
  Url.make_encoded_parameters
    (Mod_parameters.get_param_list (list_of_nl_params_set nlp))
