...
(** A value of type [('a, 'b) server_function] is created on the server from a
    ...
    See also {{!Client.server_function}the concrete client side representation}. *)
...
val server_function :
  ...
  -> ('a -> 'b Lwt.t)
  -> ('a, 'b) server_function
(** [server_function argument_type f] creates a value of type {!Client.server_function}. This allows
