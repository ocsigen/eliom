...
module Svg : sig
  ...
  *)
  module C : sig
    val node : ?init:'a elt -> 'a elt Eliom_client_common.client_value -> 'a elt
    val attr : ?init:'a attrib -> 'a attrib Eliom_client_common.client_value -> 'a attrib
  end
...
module Html5 : sig
  ...
  module C : sig
    ...
    (** See Eliom manual for more detail on {% <<a_manual
        ...
        Client-values >>%}. *)
    val node :
      ?init:'a elt -> 'a elt Eliom_client_common.client_value -> 'a elt
    val attr :
      ?init:'a attrib -> 'a attrib Eliom_client_common.client_value -> 'a attrib
  end
