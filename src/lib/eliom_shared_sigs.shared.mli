...
module type S = sig
  ...
  val fmap :
    ?eq:('b -> 'b -> bool) sv -> ('a -> 'b option) sv -> 'b sv -> 'a t -> 'b t

  val merge :
    ?eq:('a -> 'a -> bool) sv -> ('a -> 'b -> 'a) sv -> 'a -> 'b t list -> 'a t

  val l2 :
    ?eq:('c -> 'c -> bool) sv -> ('a -> 'b -> 'c) sv -> 'a t -> 'b t -> 'c t
  ...
  module Lwt : sig
    val map_s :
      ?eq:('b -> 'b -> bool) sv -> ('a -> 'b Lwt.t) sv -> 'a t -> 'b t Lwt.t
