...
(** A value of type [('a, 'b) server_function] is created on the server from a
    ...
    See also {{!Eliom_client.server_function}the concrete client side representation}. *)
...
val server_function :
  ...
  -> ('a -> 'b Lwt.t)
  -> ('a, 'b) server_function
(** [server_function argument_type f] creates a value of type {!Eliom_client.server_function}. This allows
    ...
    parameters of {!Eliom_registration.Ocaml.register_coservice'}.
