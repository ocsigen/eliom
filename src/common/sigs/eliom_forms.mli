...
7    - [port] is:
    ...
    {!val:Eliom_service.service} for a detailled description.
...
(** The function [css_link ~uri ()] creates a [<link>] node that
    ...
    {!Eliom_service.external_service} to abstract the file with a
    service.
...
(** The function [post_form service formgen get_params] creates a POST
    ...
    See {!Eliom_service.post_coservice'} for a description of the
