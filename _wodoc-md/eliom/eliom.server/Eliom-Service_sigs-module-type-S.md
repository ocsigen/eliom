...
# Module type `Service_sigs.S`


### Services

See [`Service.create`](./Eliom-Service.md#val-create) (on the server) for how to create services.
...
An Eliom service (see [`Service_sigs.S.t`](./#type-t)) can respond to one of the following HTTP methods:
