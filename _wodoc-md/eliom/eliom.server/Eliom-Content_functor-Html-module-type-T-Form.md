...
See [`make_uri`](./Eliom-Content_functor-Html-module-type-T.md#val-make_uri) for description of other optional parameters.
...
See `Service.make` for a description of the `~keep_get_na_params` optional parameter ; see [`get_form`](./#val-get_form) for `~xhr` and see [`make_uri`](./Eliom-Content_functor-Html-module-type-T.md#val-make_uri) for other optional parameters.
