...
```
```ocaml
val set_sitedata : Types.sitedata -> unit
```
```ocaml
val is_set_sitedata : unit -> bool
```
```ocaml
val get_sitedata : unit -> Types.sitedata
```
```ocaml
...
```
```ocaml
val set_info : Common.client_process_info -> unit
```
```ocaml
val is_set_info : unit -> bool
```
```ocaml
val get_info : unit -> Common.client_process_info
```
```ocaml
