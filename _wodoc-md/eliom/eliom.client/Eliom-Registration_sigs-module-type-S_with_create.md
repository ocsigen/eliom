...
# Module type `Registration_sigs.S_with_create`
...
val create : 
  ...
  ('gp,
    ...
    Service.t
```
Create a service and register it at the same time. It calls `Service.create` and then performs [`Registration_sigs.S.register`](./Eliom-Registration_sigs-module-type-S.md#val-register). Returns the service.
...
val create_attached_get : 
  ...
  ('gp,
    ...
    Service.t
```
Create an attached service and register it at the same time. It calls `Service.create_attached_get` and then performs [`Registration_sigs.S.register`](./Eliom-Registration_sigs-module-type-S.md#val-register). Returns the new service.
...
val create_attached_post : 
  ...
  ('gp,
    ...
    Service.t
```
Create an attached POST service and register it at the same time. It calls `Service.create_attached_post` and then performs [`Registration_sigs.S.register`](./Eliom-Registration_sigs-module-type-S.md#val-register). Returns the new service.
