...
By default, the form is realized such that the client-side Eliom application keeps running irrespectable of the usage of the form (cf. [`Client.change_page`](./Eliom-Client.md#val-change_page)).
...
NB that the default value of `~xhr` is configurable through `Config.set_default_links_xhr`.
