...
See the Eliom manual for a detailed introduction to the concept of [Eliom services](./../server-services.md) and to [client-side service implementation](./../clientserver-services.md).

The main functions about services are documented in [`Service_sigs.S`](./Eliom-Service_sigs-module-type-S.md).


### Services

See `Service.create` (on the server) for how to create services.
