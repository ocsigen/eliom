...
```
See [`Svg_sigs.T`](./../../tyxml/tyxml.functor/Svg_sigs-module-type-T.md).
...
Note that the concrete implementation of this type can vary. See [`Xml`](./Eliom-Content_core-Svg-R-Xml.md) for details.
