...
```
To create a link or a form with non-localized parameters, use the optional parameter <!--wodoc:span class="code"-->nl\_params<!--wodoc:end--> of functions `Eliom.Content.Html.D.a`, `Eliom.Content.Html.D.Form.get_form`, or `Eliom.Content.Html.D.Form.post_form`. Example:
