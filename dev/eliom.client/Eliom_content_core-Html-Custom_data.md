...
```
`attrib my_data value ` creates a HTML5 attribute for the custom-data type `my_data` with value `value` for injecting it into an a HTML5 tree ([`Eliom_content.Html.elt`](./../eliom.server/Eliom_content-Html.md#type-elt)).
