...
By default, the form is realized such that the client-side Eliom application keeps running irrespective of the usage of the form (cf. [`Eliom_client.change_page`](./Eliom_client.md#val-change_page)).
