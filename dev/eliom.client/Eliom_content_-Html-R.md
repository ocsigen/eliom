...
```
```ocaml
module Raw = Eliom_content_core.Html.R.Raw
```
```ocaml
...
```ocaml
module Xml = Eliom_content_core.Html.R.Xml
```
...
```ocaml
module Info = Eliom_content_core.Html.R.Info
```
...
```ocaml
val svg : 
  ?a:[< Html_types.svg_attrib ] Eliom_content_core.Svg.R.Raw.attrib list ->
  [< Html_types.svg_content ] Eliom_content_core.Svg.R.Raw.elt list_wrap ->
  [> Html_types.svg ] elt
```
...
```
```ocaml
module Unsafe = Eliom_content_core.Html.R.Unsafe
```
Unsafe features.
