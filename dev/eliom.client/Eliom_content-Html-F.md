...
By default, the link is implemented in a way that allows the client-side Eliom application to keep running, irrespective of the usage of the link (cf. [`Eliom_client.change_page`](./Eliom_client.md#val-change_page)).
