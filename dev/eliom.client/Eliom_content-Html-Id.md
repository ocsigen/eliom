...
```
The function `new_elt_id ()` creates a new global HTML5 element identifier (see the Eliom manual for more information on [global element](./../clientserver-html.md#global)).
