...
By default, the form is realized such that the client-side Eliom application keeps running irrespective of the usage of the form (cf. [`Client.change_page`](./Eliom-Client.md#val-change_page)).
