...
- Use function [`Eliom_client.is_client_app`](./eliom.server/Eliom_client.md#val-is_client_app) to test whether you are running a mobile app (an app that was started client-side). `Ocsigen Start` also has a class `os-client-app` on the `html` tag.
