...
module Xml : 
  Xml_sigs.T
    with type 'a W.t = 'a Xml_shared.W.t
    with type 'a W.tlist = 'a Xml_shared.W.tlist
    with type ('a, 'b) W.ft = ('a, 'b) Xml_shared.W.ft
    with type uri = Xml_shared.uri
    with type event_handler = Xml_shared.event_handler
    with type mouse_event_handler = Xml_shared.mouse_event_handler
    with type keyboard_event_handler = Xml_shared.keyboard_event_handler
    with type touch_event_handler = Xml_shared.touch_event_handler
    with type attrib = Xml_shared.attrib
    with type elt = Xml_shared.elt
```
