...
It calls [`Ocamlbuild_js_of_ocaml.dispatcher`](./../../js_of_ocaml-ocamlbuild/js_of_ocaml-ocamlbuild/Ocamlbuild_js_of_ocaml.md#val-dispatcher) first, with the same parameters, and then initialize the plugin for eliom.
