...
let _ =
  Eliom_registration.Html.register Eliom_testsuite_base.main (fun () () ->
      Lwt.return
        (html
           (head
           ...
           (body
                  ...
                  [ img ~alt:"Ocsigen"
                      ~src:
                        (Html.D.make_uri
                           ...
                           ["ocsigen5.png"])
                      () ]
              ; Eliom_testsuite_base.testsuite ~name:"Test suite 4"
                  Eliom_testsuite4.tests
              ; Eliom_testsuite_base.testsuite ~name:"Test suite 5"
                  Eliom_testsuite5.tests
              ...
              ; p
                  [ Raw.a
                      ~a:[a_href (Raw.uri_of_string "distillery/basic")]
                      [pcdata "Basic distillery"] ]
              ; h4 [pcdata "Parameters"]
              ; p
                  [ pcdata "A page with GET parameters: "
                  ; a coucou_params
                      [code [pcdata "coucou"]; pcdata " with params"]
                      (45, (22, "krokodile"))
                  ...
                  ; a constfix
                      [pcdata "Page with constants in suffix"]
                      ("aa", ((), "bb"))
                  ; br ()
              ...
              ; p
                  ...
                  ; a no_post_param_service
                      [code [pcdata "post"]; pcdata " without post_params"]
                      ()
                  ; br ()
              ...
              ; p
                  ...
                  ; br ()
                  ; pcdata
                      "A session based on cookies, implemented with actions, with session groups, and using a group table: "
                  ; a group_tables_example [code [pcdata "grouptables"]] ()
                  ; br ()
                  ; pcdata
                      "A session based on cookies, implemented with actions, with session groups, and using a persistent group table: "
              ...
              ; p
                  ...
                  ; br ()
                  ; pcdata
                      "A page with a persistent counter with persitent Eliom ref: "
                  ; a persref [code [pcdata "persref"]] ()
                  ; br ()
                  ; a hier1 [pcdata "Hierarchical menu"] ()
                  ; br ()
                  ; a divpage
                      [code [pcdata "a link sending a &lt;div&gt; page"]]
                      ()
                  ; br ()
                  ...
                  ; br ()
                  ; a nlparams_with_nlp
                      [pcdata "Non localized parameters (present)"]
                      (22, (11, "aa"))
                  ; br ()
                  ; a nlpost_entry
                      [pcdata "Non localized parameters on post service"]
                      ()
                  ; br ()
                  ...
                  ; br ()
                  ; a Eliom_testsuite_site.reference_scope_site
                      [pcdata "References of scope site"]
                      ()
                  ; br () ]
              ...
              ; p [a event2_service [code [pcdata "With Lwt"]] (); br ()]
              ; h3 [pcdata "Other tests"]
              ; p
                  [ a coucou [pcdata "coucou"] ()
                  ; br ()
                  ; a sumform [pcdata "alternative parameters"] ()
                  ; br ()
                  ; a sumform2 [pcdata "alternative parameters with POST"] ()
                  ; br ()
                  ; a optform [pcdata "Optional parameters"] ()
                  ; br ()
                  ; a main_neopt_service
                      [pcdata "Non-empty optional parameters"]
                      ()
                  ; br ()
                  ; a sfail [pcdata "Service raising an exception"] ()
                  ; br ()
                  ; a sraise
                      [pcdata "Wrong use of exceptions during service"]
                      ()
                  ; br ()
                  ; a getcoex
                      [pcdata "GET coservice with preapplied fallback, etc"]
                      ()
                  ; br ()
                  ; a postcoex
                      [pcdata "POST service with coservice fallback"]
                      ()
                  ; br ()
                  ; a su [pcdata "Suffix and other service at same URL"] ()
                  ; br ()
                  ; a suffixform_su2
                      [ pcdata
                          "Suffix and other service at same URL: a form towards the suffix service"
                      ]
                      ()
                  ; br ()
                  ; a su4
                      [pcdata "Suffix service with constant part and priority"]
                      ("aa", ((), "bb"))
                  ; br ()
                  ; a preappliedsuffix [pcdata "Preapplied suffix"] ()
                  ; br ()
                  ; a attnonatt_service
                      [pcdata "Attachment of non-attached coservice"]
                      ()
                  ; br ()
                  ; a constform
                      [pcdata "Form towards suffix service with constants"]
                      ()
                  ; br ()
                  ; a getact
                      [pcdata "action on GET attached coservice, etc"]
                      127
                  ; br ()
                  ; a noreload [pcdata "action with `NoReload option"] ()
                  ; br ()
                  ; a cookies2 [pcdata "Many cookies"] "le suffixe de l'URL"
                  ; br ()
                  ; a headers [pcdata "Customizing HTTP headers"] ()
                  ; br ()
                  ; a sendfileex [pcdata "Send file"] ()
                  ; br ()
                  ; a sendfile2 [pcdata "Send file 2"] "style.css"
                  ; br ()
                  ; a sendfileexception [pcdata "Do not send file"] ()
                  ; br ()
                  ; a sendfileregexp [pcdata "Send file with regexp"] ()
                  ; br ()
                  ; a suffixform2 [pcdata "Suffix 2"] ()
                  ; br ()
                  ; a suffixform3 [pcdata "Suffix 3"] ()
                  ; br ()
                  ; a suffixform4 [pcdata "Suffix 4"] ()
                  ; br ()
                  ; a nosuffix
                      [ pcdata
                          "Page without suffix on the same URL of a page with suffix"
                      ]
                      ()
                  ; br ()
                  ; a anypostform [pcdata "POST form to any parameters"] ()
                  ; br ()
                  ; a any2
                      [pcdata "int + any parameters"]
                      (3, ["Ciao", "bel"; "ragazzo", "!"])
                  ; br ()
                  ; a any3
                      [pcdata "any parameters broken (s after any)"]
                      (4, (["Thierry", "Richard"; "Sébastien", "Stéphane"], "s"))
                  ; br ()
                  ; (* broken        a any4 [pcdata "Any in suffix"] [("bo","ba");("bi","bu")]; br (); *)
                    a any5
                      [pcdata "Suffix + any parameters"]
                      ("ee", ["bo", "ba"; "bi", "bu"])
                  ; br ()
                  ; a upload [pcdata "Upload"] ()
                  ; br ()
                  ; a uploadgetform [pcdata "Upload with GET"] ()
                  ; br ()
                  ; a sufli [pcdata "List in suffix"]
                      ["bo", 4; "ba", 3; "bi", 2; "bu", 1]
                  ; br ()
                  ; a sufliform [pcdata "Form to list in suffix"] ()
                  ; br ()
                  ; a sufliopt
                      [pcdata "List of optional values in suffix"]
                      [None; Some "j"]
                  ; br ()
                  ; a sufliopt2
                      [pcdata "List of optional pairs in suffix"]
                      [None; Some ("j", "ee")]
                  ; br ()
                  ; a sufset [pcdata "Set in suffix"] ["bo"; "ba"; "bi"; "bu"]
                  ; br ()
                  ; (*         a sufli2 [pcdata "List not in the end of in suffix"] ([1; 2; 3], 4); br (); *)
                    a boollistform [pcdata "Bool list"] ()
                  ; br ()
                  ; a lilists [pcdata "List of lists in parameters"] ()
                  ; br ()
                  ; a wlf_lists
                      [pcdata "List of lists in parameters - 2nd example"]
                      [[333]]
                  ; br ()
                  ; a preappmenu [pcdata "Menu with pre-applied services"] ()
                  ; br ()
                  ; a exn_act_main
                      [pcdata "Actions that raises an exception"]
                      ()
                  ; br ()
                  ; a close_from_outside
                      [pcdata "Closing sessions from outside"]
                      ()
                  ; br ()
                  ; a set_timeout_form
                      [pcdata "Setting timeouts from outside sessions"]
                      ()
                  ; br ()
                  ; a ~fragment:"a--   ---++&é/@" ~service:url_encoding
                      [pcdata "Urls with strange characters inside"]
                      ( ["l/l%l      &l=l+l)l@"; "m\\m\"m"; "n?èn~n"]
                      , [ ( "po?po&po~po/po+po"
                          , "lo?\"l     o#lo'lo lo=lo&l      o/lo+lo" )
                        ; "bo=mo@co:ro", "zo^zo%zo$zo:zo?aaa" ] )
                  ; br ()
                  ; a
                      ~service:
                      ...
                      (["ocsigen5.png"], ["aa", "lmk"; "bb", "4"])
                  ; br ()
                  ; a extreq [pcdata "External request"] ()
                  ; br ()
                  ; a servreq [pcdata "Server request"] ()
                  ; br ()
                  ; a servreqloop [pcdata "Looping server request"] ()
                  ; br ()
                  ; a nlparams2
                      [pcdata "nl params and suffix, on void coservice"]
                      ((3, 5), 222)
                  ; br ()
                  ; a optsuf [pcdata "optional suffix"] None
                  ; br ()
                  ; a optsuf [pcdata "optional suffix"]
                      (Some ("<a to/to=3?4=2>", None))
                  ; br ()
                  ; a optsuf [pcdata "optional suffix"] (Some ("toto", Some 2))
                  ; br ()
                  ; a optsuf2 [pcdata "optional suffix 2"] (Some "un", Some 2)
                  ; br ()
                  ; a optsuf2 [pcdata "optional suffix 2"] (None, Some 2)
                  ; br ()
                  ; a optsuf2 [pcdata "optional suffix 2"] (Some "un", None)
                  ; br ()
                  ; a optsuf2 [pcdata "optional suffix 2"] (None, None)
                  ; br ()
                  ; a csrfsafe_get_example [pcdata "GET CSRF safe service"] ()
                  ; br ()
                  ; (* a csrfsafe_postget_example [pcdata "POST CSRF safe service on GET CSRF safe service"] (); br (); *)
                    a csrfsafe_session_example
                      [ pcdata
                          "POST non attached CSRF safe service in session table"
                      ]
                      ()
                  ; br ()
                  ; a unregister_example [pcdata "Unregistering services"] ()
                  ; br ()
                  ; a raw_post_example [pcdata "Raw POST data"] ()
                  ; br () ]
              ; h3 [pcdata "Eliom Client"]
              ; h4 [pcdata "Interaction"]
              ; p
                  [ a eliomclient1
                      [pcdata "Simple example of client side code"]
                      ()
                  ; br ()
                  ; a eliomclient2
                      [pcdata "Nodes with various onclick features"]
                      ()
                  ; br ()
                  ; a eliomclient3
                      [pcdata "Caml values in service parameters"]
                      ()
                  ; br ()
                  ...
                  ; br ()
                  ; a ~fragment:"id40" ~service:long_page
                      [pcdata "Fragment scrolling"]
                      ()
                  ; br ()
                  ; a live1
                      [pcdata "History handling and page load/unload events."]
                      ()
                  ; br ()
                  ; a relink_test [pcdata "Global elements"] ()
                  ; br ()
                  ; a unique1
                      [pcdata "Onload event on element and global element"]
                      ()
                  ; br ()
                  ...
                  ; (* a xhr_form_with_file [pcdata "xhr forms with file"] (); *)
                    (* br (); *)
                    a caml_service_cookies
                      [pcdata "Client process cookies with caml service"]
                      ()
                  ; br ()
                  ; a gotowithoutclient
                      [ pcdata
                          "A page that links to a service that belongs to the application but do not launch the application if it is already launched"
                      ]
                      ()
                  ; br ()
                  ; a default_no_appl
                      [pcdata "Toggle the default value of no_appl"]
                      ()
                  ; br ()
                  ; a wrapping1 [pcdata "wrapping test 1"] ()
                  ; br ()
                  ; a wrapping_big_values
                      [pcdata "wrapping test: big values"]
                      200000
                  ; br ()
                  ; a caml_service_wrapping
                      [pcdata "wrapping for caml call service"]
                      ()
                  ; br ()
                  ; a caml_service_with_onload
                      [pcdata "onload with caml call service"]
                      ()
                  ; br ()
                  ...
                  ; a domnodes_timings
                      [ pcdata
                          "Speed test for TyXMl nodes with dom semantics (previously known as unique node of scope request)"
                      ]
                      (2, 10)
                  ; br ()
                  ; a shared_dom_nodes
                      [pcdata "Multiple occurrences of unique nodes."]
                      ()
                  ; br ()
                  ; a nl_serv
                      [pcdata "Non localised parameters and eliom appl"]
                      ()
                  ; br ()
                  ; a nlpost_entry
                      [ pcdata
                          "Non localised parameters with forms in eliom appl" ]
                      ()
                  ; br () ]
              ; h4 [pcdata "Templates"]
              ; p
              ...
              ; p
                  ...
                  ; a comet2
                      [ pcdata
                          "A comet example with server to client and client to server asynchronous events"
                      ]
                      ()
                  ; br ()
                  ; a comet3
                      [pcdata "Server simultaneous events, transmitted together"]
                      ()
                  ; br ()
                  ...
                  ; br ()
                  ; a comet_message_board
                      [pcdata "Minimalistic message board"]
                      ()
                  ; br () ]
              ; h5 [pcdata "stateless"]
              ; p
                  ...
                  ; br ()
                  ; a comet_message_board_stateless
                      [pcdata "Minimalistic stateless message board"]
                      ()
                  ; br ()
                  ; a bus_multiple_times
                      [pcdata "Bus stream used multiple times"]
                      ()
                  ; br () ]
              ; h5 [pcdata "external"]
              ; p
                  [ a comet_stateless_external
                      [pcdata "comet channel on another server"]
                      ()
                  ; a external_xhr
                      [pcdata "request and external service with xhr"]
                      () ]
              ; h4 [pcdata "More tests"]
              ; p
                  [ a appl_redir
                      [pcdata "Eliom applications and redirections"]
                      ()
                  ; br ()
                  ; a noreload_appl
                      [ pcdata
                          "Eliom applications and actions with `NoReload option"
                      ]
                      ()
                  ; br ()
                  ; a nonapplprocessservice
                      [ pcdata
                          "Client process service not registered with Eliom_appl"
                      ]
                      ()
                  ; br ()
                  ; a gracefull_fail_with_file
                      [pcdata "link to a service hidden by a file"]
                      ()
                  ; br ()
                  ; a appl_with_redirect_service
              ...
              ; p
                  [ a states_test
                      [ pcdata
                          "Extensive test of Eliom references of different scopes, accessed from inside or outside the state itself"
                      ]
                      ()
                  ; br ()
                  ; pcdata "Coservices: "
...
*)
              ...
              ; p
                  ...
                  ; a tcookies [code [pcdata "tcookies"]] ()
                  ; br ()
                  ; pcdata
                      "A link inside the application that ask for an action outside the application. Eliom will ask the client side program to do a redirection: "
