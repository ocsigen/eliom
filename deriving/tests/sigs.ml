...
sig
  ...
  and ('a,'b) pmutrec_c = SS of 'a * ('a,'b) pmutrec_a * 'b | NN
  and ('a,'b) pmutrec_d = [`T of ('a,'b) pmutrec_b]
      (* deriving (Dump, Eq, Show, Functor, Typeable, Pickle) *)
      deriving (Dump, Eq, Show, Typeable, Pickle)

type 'a pmutrec_a' = ('a, 'a, 'a) pmutrec_c'
and ('a, 'b) pmutrec_b' = { pl1': ('b, 'a, 'b) pmutrec_c' ;
			    pl2': 'b pmutrec_a'; }
and ('a, 'b, 'c) pmutrec_c' =
  | SSS of 'a * 'b pmutrec_a' * 'c
  | TTT of 'a * ('c, 'b, 'a) pmutrec_c' * 'c
  | NNN
and pmutrec_d' = [`T of (int,char) pmutrec_b']
    deriving (Dump, Eq, Show, Typeable, Pickle)

  (* type 'a ff1 = F of 'a * 'a | G of int deriving (Show, Eq, Dump, Functor, Typeable, Pickle) *)
  type 'a ff1 = F of 'a * 'a | G of int deriving (Show, Eq, Dump, Typeable, Pickle)
  ...
  type t = int
      ...
      deriving (Eq, Enum, Bounded, Dump, Show, Typeable, Pickle)
end
  = Defs
...
sig
  ...
  type r1 deriving (Dump, Eq, Show, Typeable, Pickle)
  ...
  type intseq deriving (Dump, Eq, Show, Typeable, Pickle)
  type 'a seq deriving (Dump, Eq, Show, Typeable, Pickle)
  ...
  and 'a poly8 deriving (Dump, Eq, Show, Typeable, Pickle)
  type poly10 deriving (Dump, Eq, Show, Typeable, Pickle)
  type mutrec_a
  and mutrec_b
  and mutrec_c
  ...
  and ('a,'b) pmutrec_b
  and ('a,'b) pmutrec_c
  and ('a,'b) pmutrec_d deriving (Dump, Eq, Show, Typeable, Pickle)
  (* and ('a,'b) pmutrec_d deriving (Dump, Eq, Show, Functor, Typeable, Pickle) *)
  type 'a pmutrec_a'
  and ('a, 'b) pmutrec_b'
  and ('a, 'b, 'c) pmutrec_c'
  and pmutrec_d' deriving (Dump, Eq, Show, Typeable, Pickle)
  (* type 'a ff1 deriving (Show, Eq, Dump, Functor, Typeable, Pickle) *)
  (* type ('a,'b) ff2 deriving (Dump, Eq, Show, Functor, Typeable, Pickle) *)
  type 'a ff1 deriving (Show, Eq, Dump, Typeable, Pickle)
  type ('a,'b) ff2 deriving (Dump, Eq, Show, Typeable, Pickle)
  ...
  type t deriving (Eq, Enum, Bounded, Dump, Show, Typeable, Pickle)
end
  = Defs
