...
type ('a,'b,'c,'da, 'dform, 'dimg, 'dlink, 'dscript) parameters

val _noparam : 
    ('a, 'a, 'b -> 'b, [>xha] elt, [>xhform] elt, [>xhimg] elt, [>xhlink] elt, [>xhscript] elt) parameters
val _int :
    string ->
    (int -> 'a, 'a, (int name -> 'b) -> 'b, 
      int -> [>xha] elt, int -> [>xhform] elt, int -> [>xhimg] elt, int -> [>xhlink] elt, int -> [>xhscript] elt) parameters
val _unit : (unit -> 'a, 'a, 'b -> 'b, [>xha] elt, [>xhform] elt, [>xhimg] elt, [>xhlink] elt, [>xhscript] elt) parameters
val _string :
  string ->
  (string -> 'a, 'a, (string name -> 'b) -> 'b, 
     string -> [>xha] elt, string -> [>xhform] elt, string -> [>xhimg] elt, string -> [>xhlink] elt, string -> [>xhscript] elt) parameters
val _user_type :
  (string -> 'c) -> ('c -> string) -> string ->
  ('c -> 'a, 'a, ('c name -> 'b) -> 'b, 
    'c -> [>xha] elt, 'c -> [>xhform] elt, 'c -> [>xhimg] elt, 'c -> [>xhlink] elt, 'c -> [>xhscript] elt) parameters
val _useragent :
  ('a, 'b, 'c, 'da, 'dform, 'dimg, 'dlink, 'dscript) parameters -> 
    (string -> 'a, 'b, 'c,  'da, 'dform, 'dimg, 'dlink, 'dscript) parameters
val _ip :
  ('a, 'b, 'c, 'da, 'dform, 'dimg, 'dlink, 'dscript) parameters -> 
    (string -> 'a, 'b, 'c, 'da, 'dform, 'dimg, 'dlink, 'dscript) parameters
val _current_url :
  ('a, 'b, 'c,  'da, 'dform, 'dimg, 'dlink, 'dscript) parameters -> 
    (string list -> 'a, 'b, 'c,  'da, 'dform, 'dimg, 'dlink, 'dscript) parameters
val _url_suffix :
    ('a, 'b, 'c,  'da, 'dform, 'dimg, 'dlink, 'dscript) parameters ->
      (string -> 'a, 'b, 'c, 
	string -> 'da, string -> 'dform, string -> 'dimg, string -> 'dlink, string -> 'dscript) parameters
val _http_params :
  ('a, 'b, 'c, 'da, 'dform, 'dimg, 'dlink, 'dscript) parameters ->
  (http_params -> 'a, 'b, 'c, 'da, 'dform, 'dimg, 'dlink, 'dscript) parameters
val ( ** ) :
    ('a, 'b, 'c -> 'd, 'e -> xha elt, 'e -> xhform elt,  'e -> xhimg elt,
      'e -> xhlink elt, 'e -> xhscript elt) parameters ->
      ('b, 'g, 'd -> 'h,  'i -> 'ja, 'i -> 'jform, 'i -> 'jimg, 'i -> 'jlink, 'i -> 'jscript) parameters ->
	('a, 'g, 'c -> 'h, 'e -> 'i -> 'ja, 'e -> 'i -> 'jform, 'e -> 'i -> 'jimg, 'e -> 'i -> 'jlink, 'e -> 'i -> 'jscript) parameters
...
val new_url :
    ...
    params:('a, page, 'b -> xhformcontl, 
      'ca, 'cform, 'cimg, 'clink, 'cscript) parameters ->
    ('b, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'a, 
...
val new_external_url :
  ...
  params:('a, page, 'b -> xhformcontl, 
    'ca, 'cform, 'cimg, 'clink, 'cscript) parameters ->
  ('b, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'a, page, page, external_url) url

val new_state_url :
  fallback:('b, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'a, page, page, public_url internal_url) url 
  -> ('b, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'a, page, page, state_url internal_url) url

val register_url :
  url:('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'c, 'd, 'e, 'f internal_url) url -> page:'c -> unit
...
val register_new_url :
  ...
  params:('a, page, 'b -> xhformcontl, 
    'ca, 'cform, 'cimg, 'clink, 'cscript) parameters ->
  page:'a -> ('b, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'a, 
	      page, page, public_url internal_url) url

val register_new_session_url :
    fallback:('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'c, page, page, public_url internal_url) url ->
    page:'c -> ('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'c, page, page, state_url internal_url) url

val new_post_url :
  fallback:('a, 'b, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, public_url internal_url) url ->
  post_params:('h, 'd, 'j -> xhformcontl, 'da, 'dform, 'dimg, 'dlink, 'dscript) parameters ->
  ('a, 'j, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'h, 'd, public_url internal_url) url
...
val new_external_post_url :
  ...
  post_params:('h, 'i, 'j -> xhformcontl, 
    'ka, 'kform, 'kimg, 'klink, 'kscript) parameters ->
  ('b, 'j, 'ca,'cform,'cimg,'clink,'cscript, 'a, 'h, 'i, external_url) url

val new_post_state_url :
  fallback:('a, 'b, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, public_url internal_url) url ->
  post_params:('g, 'h, 'i -> xhformcontl, 
    'da, 'dform, 'dimg, 'dlink, 'dscript) parameters ->
  ('a, 'i, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'g, 'h, state_url internal_url) url

val register_post_url :
    url:('a, 'b -> 'c, 'ca,'cform,'cimg,'clink,'cscript, 'e, 'f, 'e, 'g internal_url) url -> page:'f -> unit
...
val register_new_post_url :
    ...
    post_params:('h, 'd, ('i -> 'j) -> xhformcontl, 
      'ka, 'kform, 'kimg, 'klink, 'kscript) parameters ->
    page:'h -> ('a, 'i -> 'j, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'h, 'd, public_url internal_url) url

val register_new_post_session_url :
    fallback:('a, 'b, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, public_url internal_url) url ->
    post_params:('g, 'd, ('h -> 'i) -> xhformcontl, 
      'da, 'dform, 'dimg, 'dlink, 'dscript) parameters ->
    page:'g -> ('a, 'h -> 'i, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'g, 'd, state_url internal_url) url
...
val new_actionurl :
  params:('a, unit, 'b -> xhformcontl, 
    'da, 'dform, 'dimg, 'dlink, 'dscript) parameters -> ('b, 'a) actionurl
...
val register_new_static_directory :
  ...
  (xhformcontl, xhformcontl, 
   string -> [>xha] elt, string -> [>xhform] elt, string -> [>xhimg] elt, string -> [>xhlink] elt, string -> [>xhscript] elt, 
   page, page, page, 
...
val a : ?a:([< xhaattrib > `Href ] attrib list) ->
  ('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, 'g) url ->
    url_string -> 
      xhacont elt list -> 'ca

val css_link : ?a:([< xhlinkattrib > `Href `Rel `Type ] attrib list) ->
  ('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, 'g) url -> url_string -> 'clink

val script : ?a:([< xhscriptattrib > `Src ] attrib list) ->
  ('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, 'g) url -> url_string -> 'cscript
...
val form_post : ?a:([< xhformattrib > `Method ] attrib list) ->
  ('a, 'b, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, 'g) url
    -> url_string -> 'b -> 'cform
val img : ?a:([< xhimgattrib ] attrib list) ->
  alt:string ->
  ('a, xhformcontl, 'ca,'cform,'cimg,'clink,'cscript, 'd, 'e, 'f, 'g) url -> url_string -> 'cimg
