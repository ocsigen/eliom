  ...
  Scanf.sscanf s "%d.%d.%Ld.%Ld" 
    (fun a b c d -> 
      if a>255 || b>255 || c>255L || d>255L || a<0 || b<0 || c<0L || d<0L then
        ...
        Int64.add
          (Int64.mul (Int64.add (Int64.of_int ((a*256+b)*256)) c) 256L) d)

let parse_ip_netmask s =
  try
    let (s1, s2) = sep '/' s in
    try
      let mask = int_of_string s2 in
      (parse_ip s1, mask)
    with Failure _ -> 
      let mask = match parse_ip s2 with
      | 0b11111111111111110000000000000000L -> 16
      | 0b11111111111111111111111100000000L -> 24
      | 0b11111111111111111111111110000000L -> 25
      | 0b11111111111111111111111111000000L -> 26
      | 0b11111111111111111111111111100000L -> 27
      | 0b11111111111111111111111111110000L -> 28
      | 0b11111111111111111111111111111000L -> 29
      | 0b11111111111111111111111111111100L -> 30
      | 0b11111111111111111111111111111110L -> 31
      | 0b11111111111111111111111111111111L -> 32
      | 0b11111111111111111111111000000000L -> 23
      | 0b11111111111111111111110000000000L -> 22
      | 0b11111111111111111111100000000000L -> 21
      | 0b11111111111111111111000000000000L -> 20
      | 0b11111111111111111110000000000000L -> 19
      | 0b11111111111111111100000000000000L -> 18
      | 0b11111111111111111000000000000000L -> 17
      | 0b11111111111111100000000000000000L -> 15
      | 0b11111111111111000000000000000000L -> 14
      | 0b11111111111110000000000000000000L -> 13
      | 0b11111111111100000000000000000000L -> 12
      | 0b11111111111000000000000000000000L -> 11
      | 0b11111111110000000000000000000000L -> 10
      | 0b11111111100000000000000000000000L -> 9
      | 0b11111111000000000000000000000000L -> 8
      | 0b11111110000000000000000000000000L -> 7
      | 0b11111100000000000000000000000000L -> 6
      | 0b11111000000000000000000000000000L -> 5
      | 0b11110000000000000000000000000000L -> 4
      | 0b11100000000000000000000000000000L -> 3
      | 0b11000000000000000000000000000000L -> 2
      | 0b10000000000000000000000000000000L -> 1
      | 0b00000000000000000000000000000000L -> 0
