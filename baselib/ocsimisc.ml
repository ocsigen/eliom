...
let parse_ip_netmask s =
  try
    let (s1, s2) = sep '/' s in
    try
      let mask = match int_of_string s2 with
      | 16 -> 0b11111111111111110000000000000000l
      | 24 -> 0b11111111111111111111111100000000l
      | 25 -> 0b11111111111111111111111110000000l
      | 26 -> 0b11111111111111111111111111000000l
      | 27 -> 0b11111111111111111111111111100000l
      | 28 -> 0b11111111111111111111111111110000l
      | 29 -> 0b11111111111111111111111111111000l
      | 30 -> 0b11111111111111111111111111111100l
      | 31 -> 0b11111111111111111111111111111110l
      | 32 -> 0b11111111111111111111111111111111l
      | 23 -> 0b11111111111111111111111000000000l
      | 22 -> 0b11111111111111111111110000000000l
      | 21 -> 0b11111111111111111111100000000000l
      | 20 -> 0b11111111111111111111000000000000l
      | 19 -> 0b11111111111111111110000000000000l
      | 18 -> 0b11111111111111111100000000000000l
      | 17 -> 0b11111111111111111000000000000000l
      | 15 -> 0b11111111111111100000000000000000l
      | 14 -> 0b11111111111111000000000000000000l
      | 13 -> 0b11111111111110000000000000000000l
      | 12 -> 0b11111111111100000000000000000000l
      | 11 -> 0b11111111111000000000000000000000l
      | 10 -> 0b11111111110000000000000000000000l
      | 09 -> 0b11111111100000000000000000000000l
      | 08 -> 0b11111111000000000000000000000000l
      | 07 -> 0b11111110000000000000000000000000l
      | 06 -> 0b11111100000000000000000000000000l
      | 05 -> 0b11111000000000000000000000000000l
      | 04 -> 0b11110000000000000000000000000000l
      | 03 -> 0b11100000000000000000000000000000l
      | 02 -> 0b11000000000000000000000000000000l
      | 01 -> 0b10000000000000000000000000000000l
      | 00 -> 0b00000000000000000000000000000000l
