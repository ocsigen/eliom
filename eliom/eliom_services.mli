...
val register_delayed_get_or_na_coservice :
  sp:Eliom_sessions.server_params ->
  (int * string option * Eliom_common.cookie_level option * bool option) -> 
  string
