...
- `Eliom_common.global_scope` (global value for the whole server). Eliom references are persistant if you add optional parameter \`~persistent\` to function \`Eliom\_reference.eref\`.
