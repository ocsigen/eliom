...
TOINSTALL = modules/tutorial.cmo modules/tutorial.cmi modules/monitoring.cmo server/ocsigen.cmi server/ocsigen.cmo server/ocsigenmod.cmi server/ocsigenmod.cmo server/staticmod.cmi server/staticmod.cmo server/ocsigenboxes.cmi xmlp4/ohl-xhtml/xHTML.cmi xmlp4/ohl-xhtml/xML.cmi xmlp4/ohl-xhtml/xhtml.cma xmlp4/xhtmltypes.cmi xmlp4/xhtmlsyntax.cma META lwt/lwt.cmi lwt/lwt_unix.cmi server/preemptive.cmi
