...
PLUGINSCMAOTOINSTALL = modules/ocsipersist.cmo modules/eliom.cma modules/ocsigenmod.cma  modules/module_static_cgi.cmo modules/staticmod.cmo modules/cgimod.cmo $(DUCECMAO)
PLUGINSCMITOINSTALL = modules/eliom.cmi modules/ocsigen.cmi modules/module_static_cgi.cmi modules/staticmod.cmi modules/cgimod.cmi modules/ocsigenboxes.cmi modules/eliomboxes.cmi $(DUCECMI)
