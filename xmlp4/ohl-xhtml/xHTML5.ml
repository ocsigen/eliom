...
(** Javascript events *)
    ...
    val a_onabort : cdata -> [>`OnAbort] attrib
    val a_onafterprint : cdata -> [>`OnAfterPrint] attrib
    val a_onbeforeprint : cdata -> [>`OnBeforePrint] attrib
    val a_onbeforeunload : cdata -> [>`OnBeforeUnload] attrib
    val a_onblur : cdata -> [>`OnBlur] attrib
    val a_oncanplay : cdata -> [>`OnCanPlay] attrib
    val a_oncanplaythrough : cdata -> [>`OnCanPlayThrough] attrib
    val a_onchange : cdata -> [>`OnChange] attrib
    val a_onclick : cdata -> [>`OnClick] attrib
    val a_oncontextmenu : cdata -> [>`OnContextMenu] attrib
    val a_ondblclick : cdata -> [>`OnDblClick] attrib
    val a_ondrag : cdata -> [>`OnDrag] attrib
    val a_ondragend : cdata -> [>`OnDragEnd] attrib
    val a_ondragenter : cdata -> [>`OnDragEnter] attrib
    val a_ondragleave : cdata -> [>`OnDragLeave] attrib
    val a_ondragover : cdata -> [>`OnDragOver] attrib
    val a_ondragstart: cdata -> [>`OnDragStart] attrib
    val a_ondrop : cdata -> [>`OnDrop] attrib
    val a_ondurationchange : cdata -> [>`OnDurationChange] attrib
    val a_onemptied : cdata -> [>`OnEmptied] attrib
    val a_onended : cdata -> [>`OnEnded] attrib
    val a_onerror : cdata -> [>`OnError] attrib
    val a_onfocus : cdata -> [>`OnFocus] attrib
    val a_onformchange : cdata -> [>`OnFormChange] attrib
    val a_onforminput : cdata -> [>`OnFormInput] attrib
    val a_onhashchange : cdata -> [>`OnHashChange] attrib
    val a_oninput : cdata -> [>`OnInput] attrib
    val a_oninvalid : cdata -> [>`OnInvalid] attrib
    ...
    val a_onmousewheel : cdata -> [>`OnMouseWheel] attrib
    val a_onoffline: cdata -> [>`OnOffLine] attrib
    val a_ononline : cdata -> [>`OnOnLine] attrib
    val a_onpause : cdata -> [>`OnPause] attrib
    val a_onplay : cdata -> [>`OnPlay] attrib
    val a_onplaying : cdata -> [>`OnPlaying] attrib
    val a_onpagehide : cdata -> [>`OnPageHide] attrib
    val a_onpageshow : cdata -> [>`OnPageShow] attrib
    val a_onpopstate : cdata -> [>`OnPopState] attrib
    val a_onprogress : cdata -> [>`OnProgress] attrib
    val a_onratechange : cdata -> [>`OnRateChange] attrib
    val a_onreadystatechange : cdata -> [>`OnReadyStateChange] attrib
    val a_onredo : cdata -> [>`OnRedo] attrib
    val a_onresize : cdata -> [>`OnResize] attrib
    val a_onscroll : cdata -> [>`OnScroll] attrib
    val a_onseeked : cdata -> [>`OnSeeked] attrib
    val a_onseeking : cdata -> [>`OnSeeking] attrib
    val a_onselect : cdata -> [>`OnSelect] attrib
    val a_onshow : cdata -> [>`OnShow] attrib
    val a_onstalled : cdata -> [>`OnStalled] attrib
    val a_onstorage : cdata -> [>`OnStorage] attrib
    val a_onsubmit : cdata -> [>`OnSubmit] attrib
    val a_onsuspend : cdata -> [>`OnSuspend] attrib
    val a_ontimeupdate : cdata -> [>`OnTimeUpdate] attrib
    val a_onundo : cdata -> [>`OnUndo] attrib
    val a_onunload : cdata -> [>`OnUnload] attrib
    val a_onvolumechange : cdata -> [>`OnVolumeChange] attrib
    val a_onwaiting : cdata -> [>`OnWaiting] attrib
    ...
    val a_onloadeddata : cdata -> [>`OnLoadedData] attrib
    val a_onloadedmetadata : cdata -> [>`OnLoadedMetaData] attrib
    val a_onloadstart : cdata -> [>`OnLoadStart] attrib
    val a_onmessage : cdata -> [>`OnMessage] attrib
